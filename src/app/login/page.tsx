...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      {toast && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-slate-800 text-white px-4 py-3 rounded-lg shadow">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="text-center mb-5">
            ...
            <h1 className="text-lg font-bold text-slate-800">OneClaw</h1>
          ...
          {loginMode === 'tabs' && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-sm font-medium transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 rounded-lg text-sm text-slate-700 transition-colors"
              >
              ...
              {/* 微信扫码 */}
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm font-medium transition-colors">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="请输入密码"
                        className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-orange-500 transition-colors"
                      />
                      <button
                        type="button"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="请输入验证码"
                        maxLength={6}
                        className="w-full pl-10 pr-24 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-orange-500 transition-colors"
                      />
                      <button
          ...
          {loginMode === 'tabs' && (
            <div className="mt-5 p-3 bg-slate-50 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-700">开通会员享更多权益</span>
              </div>
              <button
