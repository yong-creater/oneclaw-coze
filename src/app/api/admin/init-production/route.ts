...
const TOOLS: ToolData[] = [
  ...
  // ========== 更多视频生成工具 ==========
  { name: 'Genmo', logo: 'https://www.genmo.ai/favicon.ico', producer: 'Genmo', highlight: '创意AI视频生成', category: '视频生成', free_type: '免费额度', free_quota_desc: '$10/月', official_url: 'https://www.genmo.ai', is_featured: false, feature_tags: ['文生视频', '图生视频', 'AI配音'], advantages: ['简单易用', '多种风格', '快速生成'], limitations: ['视频时长限制'], commercial_license: '需授权商用' },
  { name: 'Kaiber', logo: 'https://kaiber.ai/favicon.ico', producer: 'Kaiber', highlight: '艺术风格视频生成', category: '视频生成', free_type: '免费额度', free_quota_desc: '$10/月', official_url: 'https://kaiber.ai', is_featured: false, feature_tags: ['文生视频', '图生视频', '艺术创作'], advantages: ['艺术风格丰富', '音乐可视化', '创意性强'], limitations: ['生成速度较慢'], commercial_license: '需授权商用' },
  { name: 'D-ID', logo: 'https://www.d-id.com/favicon.ico', producer: 'D-ID', highlight: '照片转数字人视频', category: '视频生成', free_type: '免费额度', free_quota_desc: '$5.9/月起', official_url: 'https://www.d-id.com', is_featured: false, feature_tags: ['数字人口播', 'AI配音', '多语言'], advantages: ['照片驱动说话', '实时口型同步', 'API接口'], limitations: ['形象有限'], commercial_license: '需授权商用' },
  { name: 'Colossyan', logo: 'https://www.colossyan.com/favicon.ico', producer: 'Colossyan', highlight: '企业培训视频生成', category: '视频生成', free_type: '免费试用', free_quota_desc: '$28/月', official_url: 'https://www.colossyan.com', is_featured: false, feature_tags: ['数字人口播', 'AI配音', '多语言'], advantages: ['企业培训专用', '多语言支持', '模板丰富'], limitations: ['价格较高'], commercial_license: '需授权商用' },
  { name: 'Synthesia', logo: 'https://www.synthesia.io/favicon.ico', producer: 'Synthesia', highlight: '企业级数字人制作', category: '视频生成', free_type: '付费工具', free_quota_desc: '$22/月起', official_url: 'https://www.synthesia.io', is_featured: true, feature_tags: ['数字人口播', '多语言', 'AI配音'], advantages: ['140+AI形象', '120+语言', 'PPT转视频'], limitations: ['企业定价'], commercial_license: '需授权商用' },
  { name: 'Fliki', logo: 'https://fliki.ai/favicon.ico', producer: 'Fliki', highlight: '文字转视频工具', category: '视频生成', free_type: '免费额度', free_quota_desc: '$21/月', official_url: 'https://fliki.ai', is_featured: false, feature_tags: ['文生视频', 'AI配音', '多语言'], advantages: ['文字一键转视频', '多种配音', '模板丰富'], limitations: ['免费版有限制'], commercial_license: '需授权商用' },
  { name: 'InVideo', logo: 'https://invideo.io/favicon.ico', producer: 'InVideo', highlight: '在线视频编辑器', category: '视频生成', free_type: '免费额度', free_quota_desc: '$15/月', official_url: 'https://invideo.io', is_featured: false, feature_tags: ['视频编辑', '文生视频', 'AI配音'], advantages: ['模板丰富', '简单易用', 'AI辅助'], limitations: ['水印问题'], commercial_license: '需授权商用' },
  { name: 'Pictory', logo: 'https://pictory.ai/favicon.ico', producer: 'Pictory', highlight: '长文转短视频', category: '视频生成', free_type: '免费试用', free_quota_desc: '$19/月', official_url: 'https://pictory.ai', is_featured: false, feature_tags: ['文生视频', '视频编辑', 'AI配音'], advantages: ['文章转视频', '自动剪辑', '字幕生成'], limitations: ['试用限制'], commercial_license: '需授权商用' },
  { name: 'Lumen5', logo: 'https://lumen5.com/favicon.ico', producer: 'Lumen5', highlight: '内容营销视频生成', category: '视频生成', free_type: '免费额度', free_quota_desc: '$29/月', official_url: 'https://lumen5.com', is_featured: false, feature_tags: ['文生视频', '视频编辑', '营销文案'], advantages: ['博客转视频', '品牌模板', '自动布局'], limitations: ['免费版限制'], commercial_license: '需授权商用' },
  { name: 'Steve.AI', logo: 'https://www.steve.ai/favicon.ico', producer: 'Steve.AI', highlight: '动画视频生成', category: '视频生成', free_type: '免费试用', free_quota_desc: '$15/月', official_url: 'https://www.steve.ai', is_featured: false, feature_tags: ['文生视频', '动画制作', 'AI配音'], advantages: ['动画风格多样', '快速制作', '模板丰富'], limitations: ['试用限制'], commercial_license: '需授权商用' },
  { name: 'Elai.io', logo: 'https://elai.io/favicon.ico', producer: 'Elai', highlight: 'AI培训视频生成', category: '视频生成', free_type: '免费试用', free_quota_desc: '$23/月', official_url: 'https://elai.io', is_featured: false, feature_tags: ['数字人口播', 'AI配音', '多语言'], advantages: ['培训视频专用', '多语言支持', 'PPT导入'], limitations: ['试用限制'], commercial_license: '需授权商用' },
  { name: 'HeyGen', logo: 'https://www.heygen.com/favicon.ico', producer: 'HeyGen', highlight: '顶级AI数字人平台', category: '视频生成', free_type: '免费额度', free_quota_desc: '$24/月起', official_url: 'https://www.heygen.com', is_featured: true, feature_tags: ['数字人口播', 'AI配音', '多语言'], advantages: ['100+数字人形象', '40+语言支持', '自定义数字人'], limitations: ['价格较高'], commercial_license: '需授权商用' },
  { name: 'Rephrase.ai', logo: 'https://www.rephrase.ai/favicon.ico', producer: 'Rephrase', highlight: '个性化视频生成', category: '视频生成', free_type: '付费工具', free_quota_desc: '联系销售', official_url: 'https://www.rephrase.ai', is_featured: false, feature_tags: ['数字人口播', 'AI配音', '多语言'], advantages: ['个性化视频', '企业级服务', 'API接口'], limitations: ['需要联系销售'], commercial_license: '需授权商用' },

  // ========== 更多数字人工具 ==========
  { name: '腾讯智影', logo: 'https://zenvideo.qq.com/favicon.ico', producer: '腾讯', highlight: '腾讯AI视频创作', category: '数字人', free_type: '免费额度', free_quota_desc: '会员$9.9/月', official_url: 'https://zenvideo.qq.com', is_featured: true, feature_tags: ['数字人口播', '支持中文', '视频编辑'], advantages: ['多种数字人', '智能配音', '模板丰富'], limitations: ['中文为主'], commercial_license: '需授权商用' },
  { name: '小冰数字人', logo: 'https://www.xiaoice.com/favicon.ico', producer: '小冰公司', highlight: '超拟真AI数字人', category: '数字人', free_type: '付费工具', free_quota_desc: '联系客服', official_url: 'https://www.xiaoice.com', is_featured: false, feature_tags: ['数字人口播', '支持中文', 'AI配音'], advantages: ['超逼真形象', '情感交互', '企业定制'], limitations: ['需要联系销售'], commercial_license: '需授权商用' },
  { name: '硅基智能', logo: 'https://www.guiji.ai/favicon.ico', producer: '硅基智能', highlight: 'AI数字人直播', category: '数字人', free_type: '免费试用', free_quota_desc: '联系客服', official_url: 'https://www.guiji.ai', is_featured: false, feature_tags: ['数字人口播', '支持中文', '直播'], advantages: ['直播互动', '多平台支持', '定制服务'], limitations: ['需要定制'], commercial_license: '需授权商用' },
  { name: '魔塔社区数字人', logo: 'https://www.modelscope.cn/favicon.ico', producer: '阿里达摩院', highlight: '开源数字人模型', category: '数字人', free_type: '完全免费', free_quota_desc: '完全免费', official_url: 'https://www.modelscope.cn', is_featured: false, feature_tags: ['数字人口播', '支持中文', '开源免费'], advantages: ['开源免费', '模型丰富', '社区支持'], limitations: ['需要技术能力'], commercial_license: '可免费商用' },
  { name: 'Avatarify', logo: 'https://avatarify.ai/favicon.ico', producer: 'Avatarify', highlight: '实时面部驱动', category: '数字人', free_type: '免费额度', free_quota_desc: '$5/月', official_url: 'https://avatarify.ai', is_featured: false, feature_tags: ['数字人口播', '实时驱动', '娱乐应用'], advantages: ['实时驱动', '效果逼真', '娱乐性强'], limitations: ['功能单一'], commercial_license: '需授权商用' },
  ...
  { name: 'Descript', logo: 'https://www.descript.com/favicon.ico', producer: 'Descript', highlight: 'AI音视频编辑', category: '视频编辑', free_type: '免费额度', free_quota_desc: '$12/月起', official_url: 'https://www.descript.com', is_featured: false, feature_tags: ['视频编辑', 'AI配音', '多语言'], advantages: ['文字编辑视频', 'AI声音克隆', '自动转录'], limitations: ['功能相对单一'], commercial_license: '需授权商用' },
  { name: 'Veed.io', logo: 'https://www.veed.io/favicon.ico', producer: 'Veed', highlight: '在线视频编辑平台', category: '视频编辑', free_type: '免费额度', free_quota_desc: '$12/月起', official_url: 'https://www.veed.io', is_featured: false, feature_tags: ['视频编辑', 'AI配音', '多语言'], advantages: ['自动字幕', '屏幕录制', '模板库'], limitations: ['免费版水印'], commercial_license: '需授权商用' },
  { name: 'Opus Clip', logo: 'https://opus.pro/favicon.ico', producer: 'Opus', highlight: '长视频切片工具', category: '视频编辑', free_type: '免费额度', free_quota_desc: '$9.99/月', official_url: 'https://opus.pro', is_featured: false, feature_tags: ['视频编辑', '自动剪辑', '短视频'], advantages: ['自动切片', '智能选段', '字幕生成'], limitations: ['仅限切片功能'], commercial_license: '需授权商用' },
  ...
  { name: 'Azure TTS', logo: 'https://azure.microsoft.com/favicon.ico', producer: 'Microsoft', highlight: '微软Azure语音服务', category: 'AI配音', free_type: '免费额度', free_quota_desc: '按量付费', official_url: 'https://azure.microsoft.com/services/cognitive-services/text-to-speech', is_featured: false, feature_tags: ['AI配音', '多语言', '支持中文'], advantages: ['神经网络语音', 'SSML支持', '多语言'], limitations: ['需要Azure账号'], commercial_license: '需授权商用' },
  { name: 'Murf AI', logo: 'https://murf.ai/favicon.ico', producer: 'Murf', highlight: '专业AI配音工具', category: 'AI配音', free_type: '免费额度', free_quota_desc: '$19/月起', official_url: 'https://murf.ai', is_featured: false, feature_tags: ['AI配音', '多语言', '声音克隆'], advantages: ['120+声音', '20+语言', '声音定制'], limitations: ['价格较高'], commercial_license: '需授权商用' },
  { name: 'Play.ht', logo: 'https://play.ht/favicon.ico', producer: 'Play.ht', highlight: '超逼真AI语音', category: 'AI配音', free_type: '免费额度', free_quota_desc: '$31/月', official_url: 'https://play.ht', is_featured: false, feature_tags: ['AI配音', '多语言', '声音克隆'], advantages: ['超逼真声音', '多语言', 'API接口'], limitations: ['价格较高'], commercial_license: '需授权商用' },
  { name: 'Lovo AI', logo: 'https://lovo.ai/favicon.ico', producer: 'Lovo', highlight: 'AI配音与视频创作', category: 'AI配音', free_type: '免费额度', free_quota_desc: '$24/月', official_url: 'https://lovo.ai', is_featured: false, feature_tags: ['AI配音', '多语言', '视频编辑'], advantages: ['声音丰富', '视频制作', '多语言'], limitations: ['免费版限制'], commercial_license: '需授权商用' },
  ...
  { name: '通义万相', logo: 'https://tongyi.aliyun.com/favicon.ico', producer: '阿里云', highlight: '阿里AI图像生成', category: 'AI绘画', free_type: '免费额度', free_quota_desc: '按量付费', official_url: 'https://tongyi.aliyun.com/wanxiang', is_featured: false, feature_tags: ['图片生成', '支持中文', '艺术创作'], advantages: ['中文优化', '企业级服务', 'API接口'], limitations: ['需要阿里云账号'], commercial_license: '需授权商用' },
  { name: '文心一格', logo: 'https://yige.baidu.com/favicon.ico', producer: '百度', highlight: '百度AI绘画平台', category: 'AI绘画', free_type: '免费额度', free_quota_desc: '按量付费', official_url: 'https://yige.baidu.com', is_featured: false, feature_tags: ['图片生成', '支持中文', '艺术创作'], advantages: ['中文理解', '国风特色', '多种风格'], limitations: ['生成速度一般'], commercial_license: '需授权商用' },
  { name: 'Ideogram', logo: 'https://ideogram.ai/favicon.ico', producer: 'Ideogram', highlight: '文字渲染最强', category: 'AI绘画', free_type: '免费额度', free_quota_desc: '$8/月', official_url: 'https://ideogram.ai', is_featured: false, feature_tags: ['图片生成', '艺术创作', '多风格'], advantages: ['文字渲染强', '免费额度', '简单易用'], limitations: ['风格相对有限'], commercial_license: '需授权商用' },
  { name: 'Civitai', logo: 'https://civitai.com/favicon.ico', producer: 'Civitai', highlight: 'AI模型分享社区', category: 'AI绘画', free_type: '完全免费', free_quota_desc: '完全免费', official_url: 'https://civitai.com', is_featured: false, feature_tags: ['图片生成', '开源免费', '艺术创作'], advantages: ['模型丰富', '社区活跃', '免费使用'], limitations: ['需要技术能力'], commercial_license: '可免费商用' },
  ...
  { name: '通义灵码', logo: 'https://tongyi.aliyun.com/favicon.ico', producer: '阿里云', highlight: '阿里AI编程助手', category: 'AI编程', free_type: '完全免费', free_quota_desc: '完全免费', official_url: 'https://tongyi.aliyun.com/lingma', is_featured: true, feature_tags: ['代码补全', '支持中文', '多语言'], advantages: ['完全免费', '中文支持', '多语言'], limitations: ['功能相对基础'], commercial_license: '可免费商用' },
  { name: 'CodeGeeX', logo: 'https://codegeex.cn/favicon.ico', producer: '智谱AI', highlight: '国产AI编程助手', category: 'AI编程', free_type: '完全免费', free_quota_desc: '完全免费', official_url: 'https://codegeex.cn', is_featured: false, feature_tags: ['代码补全', '支持中文', '开源免费'], advantages: ['完全免费', '中文优化', '多语言'], limitations: ['知名度较低'], commercial_license: '可免费商用' },
  { name: 'Tabnine', logo: 'https://www.tabnine.com/favicon.ico', producer: 'Tabnine', highlight: '企业级AI代码补全', category: 'AI编程', free_type: '免费额度', free_quota_desc: '$12/月', official_url: 'https://www.tabnine.com', is_featured: false, feature_tags: ['代码补全', '多语言', 'AI对话'], advantages: ['企业级安全', '私有部署', '多IDE支持'], limitations: ['免费版限制'], commercial_license: '需授权商用' },
  { name: 'Amazon CodeWhisperer', logo: 'https://aws.amazon.com/favicon.ico', producer: 'Amazon', highlight: 'AWS AI编程助手', category: 'AI编程', free_type: '免费额度', free_quota_desc: '$19/月', official_url: 'https://aws.amazon.com/codewhisperer', is_featured: false, feature_tags: ['代码补全', '多语言', 'AI对话'], advantages: ['AWS集成', '安全扫描', '免费个人版'], limitations: ['AWS生态'], commercial_license: '需授权商用' },
  ...
  { name: 'Mubert', logo: 'https://mubert.com/favicon.ico', producer: 'Mubert', highlight: 'AI背景音乐生成', category: 'AI音频', free_type: '免费额度', free_quota_desc: '$14/月', official_url: 'https://mubert.com', is_featured: false, feature_tags: ['音乐生成', '多语言', 'AI配音'], advantages: ['商用授权', '多场景模板', 'API接口'], limitations: ['风格相对有限'], commercial_license: '可免费商用' },
  { name: '网易天音', logo: 'https://tianyin.163.com/favicon.ico', producer: '网易', highlight: '网易AI音乐创作', category: 'AI音频', free_type: '免费额度', free_quota_desc: '会员$9.9/月', official_url: 'https://tianyin.163.com', is_featured: false, feature_tags: ['音乐生成', '支持中文', 'AI配音'], advantages: ['中文歌曲', '多种风格', '编曲工具'], limitations: ['中文为主'], commercial_license: '需授权商用' },
  { name: 'AIVA', logo: 'https://www.aiva.ai/favicon.ico', producer: 'AIVA', highlight: 'AI作曲家', category: 'AI音频', free_type: '免费额度', free_quota_desc: '$11/月', official_url: 'https://www.aiva.ai', is_featured: false, feature_tags: ['音乐生成', '多语言', '艺术创作'], advantages: ['古典音乐专长', '电影配乐', 'MIDI导出'], limitations: ['免费版限制'], commercial_license: '需授权商用' },
  ...
  { name: 'Beautiful.ai', logo: 'https://www.beautiful.ai/favicon.ico', producer: 'Beautiful.ai', highlight: '智能演示文稿设计', category: 'AI办公', free_type: '付费工具', free_quota_desc: '$12/月', official_url: 'https://www.beautiful.ai', is_featured: false, feature_tags: ['PPT生成', '多语言', 'AI对话'], advantages: ['智能布局', '企业模板', '团队协作'], limitations: ['需要订阅'], commercial_license: '需授权商用' },
  { name: '通义听悟', logo: 'https://tingwu.aliyun.com/favicon.ico', producer: '阿里云', highlight: '阿里会议转录助手', category: 'AI办公', free_type: '免费额度', free_quota_desc: '按量付费', official_url: 'https://tingwu.aliyun.com', is_featured: false, feature_tags: ['会议记录', '支持中文', '多语言'], advantages: ['高精度转录', '智能摘要', 'API接口'], limitations: ['需要阿里云账号'], commercial_license: '需授权商用' },
  { name: 'Otter.ai', logo: 'https://otter.ai/favicon.ico', producer: 'Otter', highlight: 'AI会议转录工具', category: 'AI办公', free_type: '免费额度', free_quota_desc: '$16.99/月', official_url: 'https://otter.ai', is_featured: false, feature_tags: ['会议记录', '多语言', 'AI对话'], advantages: ['实时转录', '说话人识别', '集成会议平台'], limitations: ['英文为主'], commercial_license: '需授权商用' },
...
export async function POST(request: NextRequest) {
  try {
    ...
    // 0. 检查数据库连接是否正常
    console.log('🔧 检查数据库连接...');
    const { error: connectionError } = await client.from('admin_users').select('id').limit(1);
    
    if (connectionError) {
      const errorMsg = connectionError.message || '';
      
      // 检查是否是表不存在的错误
      if (errorMsg.includes('does not exist') || errorMsg.includes('404') || errorMsg.includes('not found')) {
        console.error('❌ 数据库表不存在，需要先创建表结构');
