...
const CASE_STUDIES: CaseStudy[] = [
  {
    id: 'resume',
    title: '简历优化案例',
    subtitle: '从石沉大海到斩获大厂offer',
    badge: '校招求职',
    badgeColor: 'bg-blue-500',
    description: '通过STAR法则重构项目经历，突出"独立开发""性能优化"等关键词，将平平无奇的学生经历转化为面试官眼中的亮点。',
    link: '/cases/resume',
    gradient: 'from-blue-500 to-cyan-500',
    icon: FileText,
    stats: [
      { label: '简历通过率', value: '+200%' },
      { label: '面试邀约', value: '+150%' },
    ],
  },
  {
    id: 'resume-2',
    title: '社招跳槽案例',
    subtitle: '量化工作成果，精准匹配JD',
    badge: '社招跳槽',
